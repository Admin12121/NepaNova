...
PICKDROP_BASE_URL = config(
    "PICKDROP_BASE_URL", default="https://app-t.pickndropnepal.com"
).rstrip("/")
PICKDROP_API_KEY = config("PICKDROP_API_KEY", default="")
PICKDROP_API_SECRET = config("PICKDROP_API_SECRET", default="")
PICKDROP_WEBHOOK_SECRET = config("PICKDROP_WEBHOOK_SECRET", default="")
PICKDROP_WEBHOOK_SECRET_HEADER = config(
    "PICKDROP_WEBHOOK_SECRET_HEADER", default="X-Webhook-Secret"
)
PICKDROP_BUSINESS_ADDRESS = config("PICKDROP_BUSINESS_ADDRESS", default="")
PICKDROP_DEFAULT_DESTINATION_BRANCH = config(
    "PICKDROP_DEFAULT_DESTINATION_BRANCH", default=""
)
PICKDROP_DEFAULT_DESTINATION_CITY_AREA = config(
    "PICKDROP_DEFAULT_DESTINATION_CITY_AREA", default=""
)
PICKDROP_DEFAULT_ORDER_TYPE = config("PICKDROP_DEFAULT_ORDER_TYPE", default="Regular")
PICKDROP_DEFAULT_PACKAGE_WEIGHT = config(
    "PICKDROP_DEFAULT_PACKAGE_WEIGHT", default=1.0, cast=float
)
PICKDROP_DEFAULT_PACKAGE_LENGTH = config(
    "PICKDROP_DEFAULT_PACKAGE_LENGTH", default=0, cast=float
)
PICKDROP_DEFAULT_PACKAGE_WIDTH = config(
    "PICKDROP_DEFAULT_PACKAGE_WIDTH", default=0, cast=float
)
PICKDROP_DEFAULT_PACKAGE_HEIGHT = config(
    "PICKDROP_DEFAULT_PACKAGE_HEIGHT", default=0, cast=float
)
PICKDROP_DEFAULT_DIMENSION_UNIT = config(
    "PICKDROP_DEFAULT_DIMENSION_UNIT", default="cm"
)
PICKDROP_DEFAULT_INSTRUCTION = config("PICKDROP_DEFAULT_INSTRUCTION", default="")
PICKDROP_REF = config("PICKDROP_REF", default="")
PICKDROP_TIMEOUT_SECONDS = config("PICKDROP_TIMEOUT_SECONDS", default=15, cast=int)
