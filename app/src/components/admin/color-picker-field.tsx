            ...
            <div>
              <input
                ...
                className={cn(
                  ...
                  "focus:outline-none focus:ring-2 focus:ring-brandGreen"
                )}
              />
            </div>
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        ...
                        "focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-brandGreen",
                        isSelected
                          ? "border-brandGreen shadow-lg ring-2 ring-brandGreen/30"
